...
public class ValaFieldDeclarationImpl extends ValaNamedElementImpl implements ValaFieldDeclaration {

  public ValaFieldDeclarationImpl(@Nullable ASTNode node) {
    super(node);
  }
