...
public class ValaSyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    private static final TextAttributesKey[] LINE_COMMENT_KEYS = new TextAttributesKey[]{
            LINE_COMMENT
    };
    private static final TextAttributesKey[] BLOCK_COMMENT_KEYS = new TextAttributesKey[]{
            BLOCK_COMMENT
    };
    private static final TextAttributesKey[] DOC_COMMENT_KEYS = new TextAttributesKey[]{
            DOC_COMMENT
    };
    ...
    private static final TextAttributesKey[] DOT_KEYS = new TextAttributesKey[]{
            DOT
    };
    private static final TextAttributesKey[] PARENTHESES_KEYS = new TextAttributesKey[]{
            PARENTHESES
    };
    private static final TextAttributesKey[] OPERATION_KEYS = new TextAttributesKey[]{
            OPERATIONS
    };
    ...
    private static final Map<IElementType, TextAttributesKey[]> keyMap = new HashMap<>(
            Map.ofEntries(
                    ...
                    Map.entry(ValaTypes.PLUS, OPERATION_KEYS),
                    Map.entry(ValaTypes.MINUS, OPERATION_KEYS),
                    Map.entry(ValaTypes.FORWARD_SLASH, OPERATION_KEYS),
                    Map.entry(ValaTypes.MODULO, OPERATION_KEYS),
                    Map.entry(ValaTypes.EQUALS, OPERATION_KEYS),
                    Map.entry(ValaTypes.PLUS_EQUALS, OPERATION_KEYS),
                    Map.entry(ValaTypes.MINUS_EQUALS, OPERATION_KEYS),
                    Map.entry(ValaTypes.DIVIDE_EQUALS, OPERATION_KEYS),
                    Map.entry(ValaTypes.MODULO_EQUALS, OPERATION_KEYS)
            )
    );
