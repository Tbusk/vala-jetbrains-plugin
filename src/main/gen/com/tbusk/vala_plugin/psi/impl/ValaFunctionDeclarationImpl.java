...
public class ValaFunctionDeclarationImpl extends ASTWrapperPsiElement implements ValaFunctionDeclaration {

  public ValaFunctionDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public ValaFunctionBody getFunctionBody() {
    return findNotNullChildByClass(ValaFunctionBody.class);
  }
