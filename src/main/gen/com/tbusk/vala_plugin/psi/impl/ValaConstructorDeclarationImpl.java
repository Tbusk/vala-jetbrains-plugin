...
public class ValaConstructorDeclarationImpl extends ASTWrapperPsiElement implements ValaConstructorDeclaration {

  public ValaConstructorDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
