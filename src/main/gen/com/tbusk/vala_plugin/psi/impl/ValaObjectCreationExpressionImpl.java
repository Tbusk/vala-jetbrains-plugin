...
public class ValaObjectCreationExpressionImpl extends ASTWrapperPsiElement implements ValaObjectCreationExpression {

  public ValaObjectCreationExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
