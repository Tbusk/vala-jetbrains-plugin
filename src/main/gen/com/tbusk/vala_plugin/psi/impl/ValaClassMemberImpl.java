...
public class ValaClassMemberImpl extends ASTWrapperPsiElement implements ValaClassMember {

  public ValaClassMemberImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public ValaConstructorDeclaration getConstructorDeclaration() {
    return findChildByClass(ValaConstructorDeclaration.class);
  }
  ...
  @Override
  @Nullable
  public ValaDestructorDeclaration getDestructorDeclaration() {
    return findChildByClass(ValaDestructorDeclaration.class);
  }
