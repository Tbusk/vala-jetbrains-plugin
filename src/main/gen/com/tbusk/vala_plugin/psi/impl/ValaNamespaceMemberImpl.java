...
public class ValaNamespaceMemberImpl extends ASTWrapperPsiElement implements ValaNamespaceMember {

  public ValaNamespaceMemberImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ValaVisitor visitor) {
    visitor.visitNamespaceMember(this);
  }
  ...
  @Override
  @Nullable
  public ValaErrordomainDeclaration getErrordomainDeclaration() {
    return findChildByClass(ValaErrordomainDeclaration.class);
  }
  ...
  @Override
  @Nullable
  public ValaNamespaceDeclaration getNamespaceDeclaration() {
    return findChildByClass(ValaNamespaceDeclaration.class);
  }
