...
public class ValaNamespaceDeclarationImpl extends ASTWrapperPsiElement implements ValaNamespaceDeclaration {
  ...
  @Override
  @NotNull
  public List<ValaDeclaration> getDeclarationList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ValaDeclaration.class);
  }

  @Override
  @NotNull
  public ValaQualifiedName getQualifiedName() {
    return findNotNullChildByClass(ValaQualifiedName.class);
  }
