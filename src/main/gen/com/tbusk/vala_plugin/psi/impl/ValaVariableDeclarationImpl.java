...
public class ValaVariableDeclarationImpl extends ASTWrapperPsiElement implements ValaVariableDeclaration {

  public ValaVariableDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
